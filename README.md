...
**实时交互 · 格式无损 · 并行加速 · 四屏对照 · 双向翻译 · 多用户并发**
...
| **单向限制**<br>只能英文翻中文，不能中文翻英文。 | **双向翻译支持**<br>一键切换翻译方向：英文→中文 或 中文→英文。适配不同场景需求。 |
| **多人冲突**<br>多人同时使用会互相干扰。 | **多用户并发支持**<br>每个浏览器标签页独立会话，多人同时翻译不干扰，充分利用服务器资源。 |
...
<td width="50%" align="center">
<h3>🌐 双向翻译支持</h3>
<p align="left">一键切换翻译方向：<b>英文 → 中文</b> 或 <b>中文 → 英文</b>。无论是阅读英文技术文档还是将中文内容国际化，一个工具全部搞定。</p>
</td>
<td width="50%" align="center">
<h3>👥 多用户并发</h3>
<p align="left">每个浏览器标签页独立翻译会话，互不干扰。多人同时使用无压力，充分利用服务器资源，支持团队协作场景。</p>
</td>
</tr>
<tr>
<td width="50%" align="center">
...
- [x] **v1.2**: **多用户并发支持**（多标签页/多用户同时翻译）
- [ ] **v1.3**: **秒级互译**（支持双向修改，改中文自动修正英文，改英文自动更新中文）
- [ ] **v1.4**: **多模态支持**（OCR 图片转 Markdown，PDF 解析）
- [ ] **v1.5**: **本地模型量化**（集成 Ollama，断网也能跑）
